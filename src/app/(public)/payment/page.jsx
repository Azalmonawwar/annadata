...
const page = () => {
  return (
    <>
  <div
    className="w-full h-screen pt-12"
    style={{
      backgroundImage:
    ...
    <div className="w-full h-screen bg-black bg-opacity-70">
      <div className="w-full h-full flex flex-col items-start justify-between container mx-auto py-8 px-8 lg:px-4 xl:px-0">
        <div className="bg-white bg-opacity-10 px-4 py-2 rounded-xl flex items-center justify-center text-cyan-100 space-x-4">
          ...
          <span className="text-lg lg:text-2xl font-bold">Template</span>
        </div>
          ...
          <div className="flex flex-col items-center space-y-4 mt-16 px-6">
            ...
            <form className="w-full flex items-center">
              <input
                ...
                autoComplete="off"
              />
              <button className="bg-blue-600 py-2 px-6 text-gray-100 border border-blue-600 rounded-tr rounded-br text-sm">
                Subscribe
              </button>
            </form>
          </div>
