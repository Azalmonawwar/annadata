...
function Login() {
    ...
    return (
        <div className="bg-gradient-to-r from-blue-500 to-purple-500 min-h-screen flex items-center justify-center text-black pt-28">
            <div className="bg-white p-8 rounded shadow-lg sm:w-96">
